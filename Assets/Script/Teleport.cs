...
public class Teleport : MonoBehaviour, IGvrGazeResponder {
	...
	public void SetGazedAt(bool gazedAt) {
		if (GetComponent<Renderer> ()) {
			GetComponent<Renderer> ().material.color = gazedAt ? Color.cyan : Color.blue;
		} else {
			Renderer[] renderers = GetComponentsInChildren<Renderer> ();
			foreach (Renderer renderer in renderers) {
				renderer.material.SetColor("_SpecColor", gazedAt ? Color.cyan: Color.blue);
				renderer.material.color = gazedAt ? Color.cyan : Color.blue;
			}
		}
	}
