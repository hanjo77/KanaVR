...
python text-to-svg.py -- --input=$text --output=$output_path
...
blender -noaudio --background --python blender-transforms.py -- --input $output_path/$file_name.svg --output $output_path/$file_name.obj
